...
impl TimeSeriesOps {
    ...
    fn parse_datetime_string(input: &str) -> PyResult<i64> {
        ...
        let format_date_only = time::format_description::parse("[year]-[month]-[day]").unwrap();
...
impl TimeSeriesOps {
    ...
    pub fn dt_year_impl(frame: &TinyFrame, column: &str) -> PyResult<TinyFrame> {
        ...
        new_columns.insert(
            format!("{}_year", column),
            TinyColumn::Int(years.into_iter().map(|y| y as i64).collect()),
        );
    ...
    pub fn dt_month_impl(frame: &TinyFrame, column: &str) -> PyResult<TinyFrame> {
        ...
        let mut new_columns = frame.columns.clone();
        new_columns.insert(
            format!("{}_month", column),
            TinyColumn::Int(months.into_iter().map(|m| m as i64).collect()),
        );
    ...
    pub fn dt_day_impl(frame: &TinyFrame, column: &str) -> PyResult<TinyFrame> {
        ...
        new_columns.insert(
            format!("{}_day", column),
            TinyColumn::Int(days.into_iter().map(|d| d as i64).collect()),
        );
    ...
    pub fn dt_hour_impl(frame: &TinyFrame, column: &str) -> PyResult<TinyFrame> {
        ...
        new_columns.insert(
            format!("{}_hour", column),
            TinyColumn::Int(hours.into_iter().map(|h| h as i64).collect()),
        );
    ...
    pub fn dt_minute_impl(frame: &TinyFrame, column: &str) -> PyResult<TinyFrame> {
        ...
        let mut new_columns = frame.columns.clone();
        new_columns.insert(
            format!("{}_minute", column),
            TinyColumn::Int(minutes.into_iter().map(|m| m as i64).collect()),
        );
    ...
    pub fn dt_second_impl(frame: &TinyFrame, column: &str) -> PyResult<TinyFrame> {
        ...
        let mut new_columns = frame.columns.clone();
        new_columns.insert(
            format!("{}_second", column),
            TinyColumn::Int(seconds.into_iter().map(|s| s as i64).collect()),
        );
    ...
    pub fn dt_day_of_week_impl(frame: &TinyFrame, column: &str) -> PyResult<TinyFrame> {
        ...
        let mut new_columns = frame.columns.clone();
        new_columns.insert(
            format!("{}_day_of_week", column),
            TinyColumn::Int(days_of_week.into_iter().map(|d| d as i64).collect()),
        );
    ...
    pub fn dt_day_of_year_impl(frame: &TinyFrame, column: &str) -> PyResult<TinyFrame> {
        ...
        let mut new_columns = frame.columns.clone();
        new_columns.insert(
            format!("{}_day_of_year", column),
            TinyColumn::Int(days_of_year.into_iter().map(|d| d as i64).collect()),
        );
    ...
    pub fn dt_shift_impl(frame: &TinyFrame, column: &str, seconds: i64) -> PyResult<TinyFrame> {
        ...
        let shifted_strings: Vec<String> = shifted
            .iter()
            .map(|&ts| {
                OffsetDateTime::from_unix_timestamp(ts)
                    .map(|dt| {
        ...
        let mut new_columns = frame.columns.clone();
        new_columns.insert(
            format!("{}_shifted", column),
            TinyColumn::Str(shifted_strings),
        );
    ...
    fn get_timestamps_from_column(frame: &TinyFrame, column: &str) -> PyResult<Vec<i64>> {
        ...
        match col {
            ...
            TinyColumn::OptInt(v) => {
                let timestamps: Vec<i64> = v.iter().map(|opt| opt.unwrap_or(0)).collect();
                Ok(timestamps)
            }
