...
impl ValidationOps {
    ...
    pub fn validate_not_null_impl(frame: &TinyFrame, column: &str) -> PyResult<TinyFrame> {
        ...
        new_columns.insert(
            format!("{}_not_null", column),
            TinyColumn::Bool(validation_results),
        );
    ...
    pub fn validate_pattern_impl(
        ...
        let mut new_columns = frame.columns.clone();
        new_columns.insert(
            format!("{}_matches_pattern", column),
            TinyColumn::Bool(validation_results),
        );
    ...
    pub fn validation_summary_impl(
        frame: &TinyFrame,
        column: &str,
